...
> **Build a Shark Tank-style AI startup validator using connected agents in Azure AI Foundry**

[![Azure AI Foundry](https://img.shields.io/badge/Azure%20AI-Foundry-blue?logo=microsoft-azure)](https://ai.azure.com)
...
- How to create AI agents in Azure AI Foundry
...
- Anyone learning Azure AI Foundry for the first time
...
| **Azure AI Foundry Access** | Available at [ai.azure.com](https://ai.azure.com) |
...
| **Lab 1** | [Create AI Foundry Project](lab-guide/01-create-foundry-project.md) | 10 min | Set up your workspace in Azure AI Foundry |
...
This lab builds a **connected agent workflow** using Azure AI Foundry's Agent Playground:
...
If you're already familiar with Azure AI Foundry and just want the agent instructions:
...
- Built for the Azure AI Foundry ecosystem
